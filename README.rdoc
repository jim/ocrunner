...
To user this, you'll need to be set up with a test target. See http://developer.apple.com/mac/articles/tools/unittestingwithxcode3.html
...
You can see the available options by running ocrunner -h.
